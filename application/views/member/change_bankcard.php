    ...
    <div class="content-wrapper" style="padding: 0;">
            ...
            <div style="display: table;width: 100%;height: 100%;">
                <div style="display: table-cell;vertical-align: middle;text-align: center;">
                    ...
                    <div style="margin-top: 5px;">
                        <span class="top_title_text" style="margin-left: -34px;">修改银行卡</span>
                    </div>
                </div>
            </div>
        </div>
        <div class="content-body" style="margin-top: 45px;position: absolute;width: 100%;bottom: 0;top: 0;">
            <form action="<?php echo base_url ('member/change_bankcard/'.$self['id']) ?>" method="post" style="width: 100%;">
                ...
                <div style="width: 100%;padding: 0 4%;border-top: 6px solid #F7F7F7;border-bottom: 2px solid #F7F7F7;background: white;">
                    <div class="row m-0 p-0 text15_regular" style="height: 50px;line-height: 50px;">
                        ...
                        <input type="text" class="text14_regular text_placeholder" id="cardholder" name="cardholder" value="<?php echo $self['holder']; ?>" placeholder="请输入真实姓名" style="width: 75%;border: none;height: 50px;padding: 5px 10px;outline: 0;">
                    </div>
                </div>
                <div style="width: 100%;padding: 0 4%;background: white;">
                    <div class="row m-0 p-0 text15_regular" style="height: 50px;line-height: 50px;">
                        <span class="black444" style="width: 25%;">身份证号码</span>
                        <input type="number" class="text14_regular text_placeholder" id="identification" name="identification" value="<?php echo $self['identity']; ?>" placeholder="请输入真实身份证号码" style="width: 75%;border: none;height: 50px;padding: 5px 10px;outline: 0;">
                    </div>
                </div>
                ...
                <div class="mt-1" style="width: 100%;padding: 0 4%;background: white;border-bottom: 2px solid #F7F7F7;">
                    <div class="row m-0 p-0 text15_regular" style="height: 50px;line-height: 50px;">
                        ...
                        <input type="text" class="text14_regular text_placeholder" id="bank" name="bank" value="<?php echo $self['bank']; ?>" placeholder="请输入开户行" style="width: 75%;border: none;height: 50px;padding: 5px 10px;outline: 0;">
                    </div>
                </div>
                <div style="width: 100%;padding: 0 4%;background: white;">
                    <div class="row m-0 p-0 text15_regular" style="height: 50px;line-height: 50px;">
                        <span class="black444" style="width: 25%;">银行卡号</span>
                        <input type="text" class="text14_regular text_placeholder" id="card_number" name="card_number" value="<?php echo $self['number']; ?>" placeholder="请输入本人真实银行卡号" style="width: 75%;border: none;height: 50px;padding: 5px 10px;outline: 0;">
                    </div>
                </div>
                ...
                <div class="mt-1" style="width: 100%;padding: 0 4%;border-bottom: 2px solid #F7F7F7;background: white;">
                    <div class="row m-0 p-0 text15_regular" style="height: 50px;line-height: 50px;">
                        ...
                        <input type="text" class="text14_regular text_placeholder" id="phone" name="phone" value="<?php echo $self['phone']; ?>" placeholder="请输入手机号" style="width: 75%;border: none;height: 50px;padding: 5px 10px;outline: 0;">
                    </div>
                </div>
                <div style="width: 100%;padding: 0 4%;background: white;">
                    <div class="row m-0 p-0 text15_regular" style="height: 50px;line-height: 50px;">
        ...
        border-radius: 8px;height: 37px;margin-top: auto;margin-bottom: auto;">验证码</button>
                ...
                <div class="col-sm-12 mt-4 mb-2 pl-2 pr-2">
                    <button type="button" onclick="change_bankcard()" class="btn mb-1" style="width: 100%;color: white;background: #90C549;box-shadow: 1px 2px 4px 0 rgba(144,197,73,0.36);
        border-radius: 8px;height: 45px;">修改</button>
                </div>
            </form>
        </div>
    <input type="hidden" id="result_bank" value="<?php if (isset($sms)) echo $sms; ?>">
    </div>
</div>
<style>
