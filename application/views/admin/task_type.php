		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="form-group">
					<select class="form-control" id="cat_edit">
...
<div class="modal animated slideInDown text-left" id="addModal" tabindex="-1" role="dialog">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="form-group">
					<select class="form-control" id="cat_add">
						<option value="-1">【请选择类别】</option>
						<?php
						if (isset($cats)) {
							foreach ($cats as $row) {
				...
				<div class="form-group">
					<input type="text" class="form-control" id="value" placeholder="请输入任务名称" />
				</div>
				<div class="form-group">
					<input type="text" class="form-control" id="cost" placeholder="请输入任务费用" />
				</div>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn grey btn-outline-secondary" data-dismiss="modal">取消</button>
