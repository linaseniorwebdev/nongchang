...
class User_model extends CI_Model {
	...
	public function __construct() {
		...
		$this->table = 'users';
		$this->column_order = array(null, 'id', 'username', 'phone', 'fullname', 'status');
		$this->column_search = array('username', 'phone', 'fullname');
	...
	/**
	 * Function to get user by unique number
	 * @param $number
	 * @return array
	 */
	public function get_by_number($number) {
		return $this->db->get_where('users', array('usernum' => $number))->row_array();
	}
}
